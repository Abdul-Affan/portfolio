    ...
    <div className="app">
      ...
      <nav className={scrolled ? 'scrolled' : ''}>
        <div className="container nav-content">
          ...
          <a href="/resume.pdf" target="_blank" rel="noreferrer" className="cta-button" style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '0.9rem', padding: '0.6rem 1.5rem' }}>
          ...
          <div className="container hero-container">
            <div className="hero-content" data-reveal>
              ...
              <div className="contact-info-mini">
                ...
                <a href="mailto:abdul.mca24@cmrit.ac.in" className="contact-link-mini" style={{ display: 'flex', alignItems: 'center', gap: '8px', color: 'inherit', textDecoration: 'none' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--accent-primary)' }}>
              ...
              <div className="social-icons-mini">
                <a href="https://github.com/Abdul-Affan/" target="_blank" rel="noreferrer" className="social-icon-circle">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                </a>
                <a href="https://www.linkedin.com/in/abdul-affan-64471a31a/" target="_blank" rel="noreferrer" className="social-icon-circle">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                </a>
                <a href="https://leetcode.com/AbdulAffan/" target="_blank" rel="noreferrer" className="social-icon-circle">
      ...
      <footer style={{ padding: '4rem 0', borderTop: '1px solid var(--glass-border)', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1.5rem' }}>
        <p style={{ color: 'var(--text-muted)', margin: 0 }}>&copy; 2026 Abdul Affan. All rights reserved.</p>
        <div className="social-icons-mini" style={{ marginTop: 0 }}>
          <a href="https://github.com/Abdul-Affan/" target="_blank" rel="noreferrer" className="social-icon-circle">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
          </a>
            ...
            <div className="modal-body">
              ...
              >
                <div className="modal-image-overlay">
                  ...
                  <a href={selectedProject.github} target="_blank" rel="noreferrer" className="modal-github-btn">
